...
class User_model extends CI_Model {
    ...
    public function addUser($data) {
         ...
         */
        $data = $this -> prepareArray($data, array('Foermlich', 'Name', 'Vorname', 'Strasse', 'Hausnr', 'Plz', 'Ort',
        'Bezirk', 'Geburtstag', 'Beruf', 'Arbeitszeit', 'JrkMitglied', 'Faehigkeiten', 'BevorzugteKommunikation',
        'LetzteAenderung', 'Anmerkung', 'Facebook', 'Geschlecht', 'MitgleidSeit', 'Besonderheiten',
        'Fuehrerschein', 'ErweitertesFuehrungszeugnis', 'ZeugnisVorlgeletam'));
